...
$ionicPlatform.ready(function()
{
   ...
   $cordovaSQLite.execute(db, "CREATE TABLE IF NOT EXISTS items (id integer primary key,  nivel integer, categ integer, item integer, desc text, pathImagen1 text, pathImagen2 text, pathImagen3 text, resp1 text, pathR1 text, resp2 text, pathR2 text, resp3 text, pathR3 text, frase text, frasecompleta text)");
      ...
      $cordovaSQLite.execute(db, "INSERT INTO items (nivel, categ, item, desc , pathImagen1, pathImagen2, pathImagen3, resp1 , pathR1 , resp2, pathR2 , resp3 , pathR3 , frase, frasecompleta) VALUES (0,3,3, 'CAT',    'img/0303.jpg','','','PIG','sonidos/0307.mp3','HORSE','sonidos/0301.mp3','CAT','sonidos/0303.mp3',' ','sonidos/0303.mp3')");
      $cordovaSQLite.execute(db, "INSERT INTO items (nivel, categ, item, desc , pathImagen1, pathImagen2, pathImagen3, resp1 , pathR1 , resp2, pathR2 , resp3 , pathR3 , frase, frasecompleta) VALUES (0,3,4, 'DOG',    'img/0304.jpg','','','DOG','sonidos/0304.mp3','CAT','sonidos/0303.mp3','TURTLE','sonidos/0305.mp3',' ','sonidos/0304.mp3')");
      ...
      //Categoria 4
      $cordovaSQLite.execute(db, "INSERT INTO items (nivel, categ, item, desc , pathImagen1, pathImagen2, pathImagen3, resp1 , pathR1 , resp2, pathR2 , resp3 , pathR3 , frase, frasecompleta) VALUES (0,4,1, 'DOLL',       'img/0401.jpg','','','DOLL','sonidos/0401.mp3','BLOCKS','sonidos/0405.mp3','CLAY','sonidos/0408.mp3', ' ','sonidos/0401.mp3')");
      ...
      $cordovaSQLite.execute(db, "INSERT INTO items (nivel, categ, item, desc , pathImagen1, pathImagen2, pathImagen3, resp1 , pathR1 , resp2, pathR2 , resp3 , pathR3 , frase, frasecompleta) VALUES (0,4,5, 'BLOCKS',     'img/0405.jpg','','','DOLL','sonidos/0401.mp3','BLOCKS','sonidos/0405.mp3','CLAY','sonidos/0408.mp3',' ','sonidos/0405.mp3')");
      ...
      $cordovaSQLite.execute(db, "INSERT INTO items (nivel, categ, item, desc , pathImagen1, pathImagen2, pathImagen3, resp1 , pathR1 , resp2, pathR2 , resp3 , pathR3 , frase, frasecompleta) VALUES (0,5,2, 'HAND',  'img/0502.jpg','','','FEET','sonidos/0503.mp3','HAND','sonidos/0502.mp3','ARM','sonidos/0505.mp3',' ','sonidos/0502.mp3')");
      ...
      $cordovaSQLite.execute(db, "INSERT INTO items (nivel, categ, item, desc , pathImagen1, pathImagen2, pathImagen3, resp1 , pathR1 , resp2, pathR2 , resp3 , pathR3 , frase, frasecompleta) VALUES (0,5,4, 'LEG',   'img/0504.jpg','','','LEG','sonidos/0504.mp3','ARM','sonidos/0505.mp3','HAND','sonidos/0502.mp3',' ','sonidos/0504.mp3')");
      ...
      $cordovaSQLite.execute(db, "INSERT INTO items (nivel, categ, item, desc , pathImagen1, pathImagen2, pathImagen3, resp1 , pathR1 , resp2, pathR2 , resp3 , pathR3 , frase, frasecompleta) VALUES (0,6,3, 'GOOD MORNING',  'img/0603.jpg','','','BYE','sonidos/0601.mp3','GOOD MORNING','sonidos/0603.mp3','GOOD AFTERNOON','sonidos/0604.mp3',' ','sonidos/0603.mp3')");
    ...
    //Nivel 2  ()
      ...
      //Categoria 4
      $cordovaSQLite.execute(db, "INSERT INTO items (nivel, categ, item, desc , pathImagen1, pathImagen2, pathImagen3, resp1 , pathR1 , resp2, pathR2 , resp3 , pathR3 , frase, frasecompleta) VALUES (2,4,1, '',  'img/2401.jpg','img/2402.jpg','img/2403.jpg','SCARF','sonidos/2401.mp3','JACKET','sonidos/2402.mp3','SHIRT','sonidos/2403.mp3', ' ',' ')");
